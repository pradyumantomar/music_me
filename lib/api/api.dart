...
import 'package:music_app/DB/albums.db.dart';
import 'package:music_app/DB/playlists.db.dart';
import 'package:music_app/extension/l10n.dart';
import 'package:music_app/main.dart';
import 'package:music_app/services/data_manager.dart';
import 'package:music_app/services/lyrics_manager.dart';
...
Future<List<Map<String, int>>> getSkipSegments(String id) async {
  try {
    ...
    if (res.body != 'Not Found') {
      final data = await jsonDecode(utf8.decode(res.bodyBytes));

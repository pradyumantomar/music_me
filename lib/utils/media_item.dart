...
MediaItem mapToMediaItem(Map song, String songUrl) => MediaItem(
    ...
    UriAudioSource createAudioSource(MediaItem mediaItem) => AudioSource.uri(Uri.parse(mediaItem.extras!['url'].toString(),
    ),tag: mediaItem,);

    createAudioSources(List<MediaItem> mediaItems){
      return mediaItems
      .map(
